...
var AppComponent = (function () {
    ...
    AppComponent.prototype.changeActivity = function () {
...
var CommentComponent = (function () {
    ...
    CommentComponent.prototype.checkInput = function () {
    ...
    CommentComponent.prototype.createComment = function () {
        ...
        if (this.isError === false) {
            ...
            this.commentService.createComment(this.comment)
                ...
                _this.comment = new __WEBPACK_IMPORTED_MODULE_1__comment__["a" /* Comment */]();
            })
                .catch(function (err) { return console.log(err); });
        }
    };
